...
namespace CarBook.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminStatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            #region İstatistik1
            var responseMessage = await client.GetAsync("https://localhost:7259/api/Statistics/GetCarCount");
            ...
            #region İstatistik2
            var responseMessage2 = await client.GetAsync("https://localhost:7259/api/Statistics/GetLocationCount");
            ...
            #region İstatistik3
            var responseMessage3 = await client.GetAsync("https://localhost:7259/api/Statistics/GetAuthorCount");
            ...
            #region İstatistik4
            var responseMessage4 = await client.GetAsync("https://localhost:7259/api/Statistics/GetBlogCount");
            ...
            #region İstatistik5
            var responseMessage5 = await client.GetAsync("https://localhost:7259/api/Statistics/GetBrandCount");
            ...
            #region İstatistik6
            var responseMessage6 = await client.GetAsync("https://localhost:7259/api/Statistics/GetAvgRentPriceForDaily");
            ...
            #region İstatistik7
            var responseMessage7 = await client.GetAsync("https://localhost:7259/api/Statistics/GetAvgRentPriceForWeekly");
            ...
            #region İstatistik8
            var responseMessage8 = await client.GetAsync("https://localhost:7259/api/Statistics/GetAvgRentPriceForMonthly");
            ...
            #region İstatistik9
            var responseMessage9 = await client.GetAsync("https://localhost:7259/api/Statistics/GetCarCountByTranmissionIsAuto");
            ...
            #region İstatistik10
            var responseMessage10 = await client.GetAsync("https://localhost:7259/api/Statistics/GetBrandNameByMaxCar");
            ...
            #region İstatistik11
            var responseMessage11 = await client.GetAsync("https://localhost:7259/api/Statistics/GetBlogTitleByMaxBlogComment");
            ...
            #region İstatistik12
            var responseMessage12 = await client.GetAsync("https://localhost:7259/api/Statistics/GetCarCountByKmSmallerThen1000");
            ...
            #region İstatistik13
            var responseMessage13 = await client.GetAsync("https://localhost:7259/api/Statistics/GetCarCountByFuelGasolineOrDiesel");
            ...
            #region İstatistik14
            var responseMessage14 = await client.GetAsync("https://localhost:7259/api/Statistics/GetCarCountByFuelElectric");
            ...
            #region İstatistik15
            var responseMessage15 = await client.GetAsync("https://localhost:7259/api/Statistics/GetCarBrandAndModelByRentPriceDailyMax");
            ...
            #region İstatistik16
            var responseMessage16 = await client.GetAsync("https://localhost:7259/api/Statistics/GetCarBrandAndModelByRentPriceDailyMin");
